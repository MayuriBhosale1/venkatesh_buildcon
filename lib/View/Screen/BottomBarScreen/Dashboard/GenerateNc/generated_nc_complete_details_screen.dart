              ...
              children: [
                ...
                if (isMaker &&
                  ...
                  if (mergedOverallRemarks != null &&
                    ...
                    _buildDetailRow("Maker Remarks", mergedOverallRemarks)
                ...
                if ((mergedApproverRemark ?? _approverRemark)?.isNotEmpty ==
                    true)
                  _buildDetailRow("Approver Remarks",
...
//=================================================>
                    ...
                    children: [
                      Expanded(
                        child: ElevatedButton(
                          // onPressed: () => _handleApproveReject("approved"),
  ...
  // Robust backend close images renderer
...
//Checker image
  Widget _buildDetailRow(String label, String? value) {
    ...
    } else if (label == "Maker Images" && value != null && value.isNotEmpty) {
      try {
        Uint8List decodedImage = base64Decode(value);
        return Padding(
          padding: const EdgeInsets.symmetric(vertical: 12.0),
...
//     if (args != null && args["screen"] == "notification") {
//       fromNotification = true;
//       routedData = args["ncRoutingData"] as NcRoutingThroughNotificationModel?;
//     }
//     //==================
//     mergedNcId = fromNotification ? routedData?.ncId : widget.ncId;
//     //16/12
//     if (mergedNcId == null) {
//       debugPrint(" mergedNcId is NULL – blocking screen build");
//     }
// //==================
...
//   Future<void> _submitForm() async {
//     if (overallRemark == null || overallRemark!.isEmpty) {
//       _showSnackbar("Description is required.", isSuccess: false);
//       return;
//     }
//     if (closeImages.isEmpty) {
//       _showSnackbar("Rectified image is required.", isSuccess: false);
//       return;
//     }
//     setState(() {
//       isLoading = true;
